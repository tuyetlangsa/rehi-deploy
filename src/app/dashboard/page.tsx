...
import { TrendingUp, TrendingDown, Users, DollarSign, LucideIcon } from 'lucide-react';
...
const SUBSCRIPTIONS: Subscription[] = [
    { email: 'lelambanksio@gmail.com', amount: '$59.9' },
    { email: 'phaannisa@gmail.com', amount: '$2.9' },
    { email: 'kamyskiwet@gmail.com', amount: '$10' },
    { email: 'hongduunghoee@gmail.com', amount: '$2.9' },
    { email: 'rawnybong@gmail.com', amount: '$2.9' },
    { email: 'phudanehah@gmail.com', amount: '$59.9' },
    { email: 'glabovknayitligusah@gmail.com', amount: '$10' },
    { email: 'laolithoongolumat@gmail.com', amount: '$2.9' },
];
        ...
        <div className="min-h-screen bg-background">
            <div className="p-8">
                <div className="mb-8">
                    ...
                    <h2 className="text-2xl font-semibold text-muted-foreground">Dashboard</h2>
                </div>
                                ...
                                <div className="space-y-3 pr-4">
                                    {SUBSCRIPTIONS.map((sub, idx) => (
                                        ...
                                        >
                                            ...
                                            <span className="text-sm font-semibold ml-2">{sub.amount}</span>
                                        </div>
                                    ))}
                                </div>
                            </ScrollArea>
