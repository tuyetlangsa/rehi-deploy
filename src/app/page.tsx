...
const Dashboard: React.FC = () => {
  ...
  // Map API data to match PieChartLegend format (convert month to name)
  const planData: PlanDistributionItem[] = (
    dashboardInfo?.planDistributionChartDatas || []
  ).map((item) => ({
  ...
  const billingData: PlanDistributionItem[] = (
    dashboardInfo?.billingDistributionChartDatas || []
  ).map((item) => ({
    name: String(item.name),
    value: item.value,
    color: item.color,
